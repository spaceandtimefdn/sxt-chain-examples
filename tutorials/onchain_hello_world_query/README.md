...
In this tutorial, we will be running an onchain query against the table created in the ["Create Table Hello World Tutorial"](../create_hello_world_table/). This query uses Proof of SQL, a cryptographic protocol that gives smart contracts a guarentee of the correctness of the query result.
...
```
forge create HelloWorld --private-key $PRIVATE_KEY --broadcast --verify
```
